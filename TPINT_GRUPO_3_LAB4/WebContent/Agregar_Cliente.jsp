	...
	<div class="Ingreso">
		...
		<table style="margin-top:5%;"  >
			...
			<tr>
				...
				<td>
					<input type="text" name="txtDirecc" Style="margin-left:20px;" class="form-control" autocomplete="off" required placeholder="escribe la dirección"/>
				</td>
			</tr>
			<tr>
				<td><h4>Email</h4></td>
			...
			<tr>
				...
				<td>
					<input type="password" name="txtConfirContra" Style="margin-left:20px;" autocomplete="off" class="form-control" required placeholder="confirme la contraseña"/>
				</td>
			</tr>
			<tr>
				<td></td>
