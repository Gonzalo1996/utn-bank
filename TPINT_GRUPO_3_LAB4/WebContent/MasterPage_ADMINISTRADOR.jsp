...
<body>
	...
	<nav class="navbar navbar-light" style="background-color: #FFA500;">
	  	...
	  	<!-- Aquí se configuraría para poner el nombre del Usuario Logueado -->Hola, Administrador
	</nav>
	<form action="servletLogin" method="post">
		<ul class="ul-master"> <!-- class="nav flex-column" NO VA-->
  		...
  		<h4>Prestamos</h4>
  		<li class="nav-item">
    		<a class="nav-link" href="Prestamos.jsp">Ver Préstamos</a>
  		</li>
   		<li class="nav-item">
    		<a class="nav-link" href="Informes_Estadisticas.jsp">Informe/Estadísticas</a>
  		</li>
  

   		<li class="nav-item">
    		<a class="nav-link" href="IngresoUsuario.jsp?cerrar=true">Cerrar Sesión</a>
  		</li>
		</ul>
	</form>
