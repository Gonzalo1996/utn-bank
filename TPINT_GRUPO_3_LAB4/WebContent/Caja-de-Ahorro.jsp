...
<%
	...
	listaCuentas = (ArrayList<Cuentas>)MyC.traerCuentasxCliente_CA(dni);
%>
...
<!-- Barra Título -->
	<jsp:include page="MasterPage_USUARIO.jsp"></jsp:include>
		...
		<div id="general">
		<br>
		<h1 id="titulo">Cuentas de Caja de Ahorro</h1>
		<br>
...
<%if(listaCuentas != null || listaCuentas.size() != 0){ %>
		...
		<form action="servletTraerMovimientos" method="post">
    		...
    		<td><input type="submit" name="btnCAJADEAHORRO" value="Ver Movimientos"></td>
  			</form>
  			</tr>
  			<%}%>
		</table>
...
<div style="background-color: rgba(255,255,0,0.40); color: white;"><em>Usted no posee Cuentas de Caja de Ahorro</em></div>
<%} %>
	</div>
